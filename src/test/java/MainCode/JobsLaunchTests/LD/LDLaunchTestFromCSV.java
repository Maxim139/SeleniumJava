...
public class LDLaunchTestFromCSV {
...
public static void upgradePlanBefore() throws IOException, InterruptedException{
    ...
    @Test
    public void LDLaunchFromCSV() throws InterruptedException, IOException{
      ...
      Thread.sleep(1000);
       ...
       AssertionsJobWizard.assertName(driver);
        ...
        AssertionsJobWizard.assertDiscoveryJobFromCSVLaunched(driver);
