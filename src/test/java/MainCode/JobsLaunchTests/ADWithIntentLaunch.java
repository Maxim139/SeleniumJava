...
public class ADWithIntentLaunch {
  ...
  @BeforeAll
    ...
    @Test
    void adWithIntent() throws InterruptedException {
      ...
      Spinners.spinnerGlobalCriteria(driver);
        ...
        //Selecting "Brazil" in HQ Location
        wizard.selectHQLocation("Brazil");
      ...
      wizard.disableMockDataToggle();
       ...
       AssertionsJobWizard.assertName(driver);
        ...
        //checking if the number of companies in AD with intent preview is not "0"
